No redundant values:
  ...
  remove-useless-else-unit=false (profile conventional (file .ocamlformat:1))
  remove-useless-sequence-unit=false (profile conventional (file .ocamlformat:1))
...
Redundant values from the ocamlformat profile:
  ...
  remove-useless-else-unit=false (profile ocamlformat (file .ocamlformat:1))
  remove-useless-sequence-unit=false (profile ocamlformat (file .ocamlformat:1))
